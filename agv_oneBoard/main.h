...
#define RFID_TAG_PINUP_GO	105 // pdy_20220919 Change the number [up <-> down]
#define RFID_TAG_PINDN_GO	104 // pdy_20220919 Change the number [up <-> down]
