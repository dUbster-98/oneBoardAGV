...
#ifdef DEBUG_PIN
	Serial.println((String) "ckeck_st_time: " + check_start_time + "curr_time: " + curr_time);
#endif /* DEBUG_PIN */
...
#ifdef DEBUG_MOT
		Serial.println("rightyyyyyyyyyy in");
#endif /* DEBUG_MOT */
...
#ifdef DEBUG_MOT
			Serial.println("sppppppppeeeeeeeeeeeeeddddddddddddd");
#endif /* DEBUG_MOT */
		}
...
{
#ifdef DEBUG_MOT
	Serial.println("># rightyyyyyyyyyyyyyyyyyyyyyyyyyyyy");
#endif /* DEBUG_MOT */
	switch(line_val)
	{
...
{
#ifdef DEBUG_MOT
	Serial.println("># reftyyyyyyyyyyyyyyyyyyyyyyyyyyyyy");
#endif /* DEBUG_MOT */
	...
	switch(line_read_val)
	{
		...
		default:
#ifdef DEBUG_MOT
			Serial.println((String)"># Unknown case: UP - " + up_side + "DOWN: " + down_side);
#endif /* DEBUG_MOT */
...
void turnleftMotor(void)
{
	...
	{
#ifdef DEBUG_MOT
		Serial.println((String) "turn-stop: upside "+ up_side + "downside: " + down_side);
#endif /* DEBUG_MOT */
...
static int ckr_eeprom_read(void)
{
	...
	Serial.println((String)"TOP" + _EEPROM_RD_TOP_RFID + "SPEED" + _EEPROM_RD_MOT_SPEED);
...
static int ckr_read_bottom_line(void)
{
	...
	//Serial.println((String)"test side_sum: UP " +up_side + "Down: " + down_side );
