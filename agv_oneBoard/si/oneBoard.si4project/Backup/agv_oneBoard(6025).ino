...
static int ckr_motor_go(void)
{
	...
	if(agv_cb.motor_go_btn_flag == 1)// || (agv_cb.drv_info.move_start_by_rfid_tag == TRUE))
	{
		...
		{
			Serial.println("MOT_TURN");
			analogWrite(LEFT_MOTOR, Mot_Descript_Turn[agv_cb.drv_info.turn_direction][0]);
			analogWrite(RIGHT_MOTOR, Mot_Descript_Turn[agv_cb.drv_info.turn_direction][1]);
		...
		if(agv_cb.drv_info.speed_mode == LOW_SPEED)	// Normal speed
		{
			...
			{
				Serial.println("LOW SPEED LEFTY");
				analogWrite(LEFT_MOTOR, Mot_Descript_Lefty[DIR_LEFTY][DIR_LEFTY]);
				analogWrite(RIGHT_MOTOR, Mot_Descript_Lefty[DIR_RIGHTY][DIR_RIGHTY]);
				//delay(1000);
			}
			else
			{
				Serial.println("LOW SPEED RIGHTY");
				analogWrite(LEFT_MOTOR, Mot_Descript_Righty[DIR_LEFTY][DIR_LEFTY]);
				analogWrite(RIGHT_MOTOR, Mot_Descript_Righty[DIR_RIGHTY][DIR_RIGHTY]);
				//delay(1000);
			}
		}
		else
		{
			if(agv_cb.drv_info.drv_direction_info == DIR_LEFTY)
			{
				Serial.println("HIGH SPEED LEFTY");
				analogWrite(LEFT_MOTOR, HIGH_Mot_Descript_Lefty[DIR_LEFTY][DIR_LEFTY]);
				analogWrite(RIGHT_MOTOR, HIGH_Mot_Descript_Lefty[DIR_RIGHTY][DIR_RIGHTY]);
				//delay(1000);
			}
			else
			{
				Serial.println("HIGH SPEED RIGHTY");
				analogWrite(LEFT_MOTOR, HIGH_Mot_Descript_Righty[DIR_LEFTY][DIR_LEFTY]);
				analogWrite(RIGHT_MOTOR, HIGH_Mot_Descript_Righty[DIR_RIGHTY][DIR_RIGHTY]);
				//delay(1000);
			}			
		}
		//if(agv_cb.drv_info.drv_direction_info == DIR_LEFTY)
