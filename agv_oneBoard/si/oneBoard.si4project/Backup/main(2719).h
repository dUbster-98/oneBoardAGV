...
#define LINE_SENSOR1		24
#define LINE_SENSOR2		25
#define LINE_SENSOR3		26
#define LINE_SENSOR4		27
#define LINE_SENSOR5		28
#define LINE_SENSOR6		29
#define LINE_SENSOR7		30
#define LINE_SENSOR8		31
#define LINE_SENSOR9		32
#define LINE_SENSOR10		33
#define LINE_SENSOR11		34
#define LINE_SENSOR12		35
...
#define _READ_LINE_SEN1 (!digitalRead(LINE_SENSOR1))
...
typedef struct {
	...
	bool motor_go_btn_flag;			// ckr_jhshin_220712[motor go or stop flag]
...
int MOT_LEFTY_2[3][13] = 
{
	...
	{0x7FF,0x3FF,0x9FF,0xCFF,0xE7F,0xF3F,0xF9F,0xFCF,0xFE7,0xFF3,0xFF9,0xFFC,0xFFE}	
};
int MOT_LEFTY_3[3][14] = 
{
	{50,50,50,50,50,50,50,50,50,50,60,60,60,60},
	{60,60,60,60,60,60,50,50,50,50,50,50,50,50},
	{0x7FF,0x3FF,0x1FF,0x8FF,0xC7F,0xE3F,0xF1F,0xF8F,0xFC7,0xFE3,0xFF1,0xFF8,0xFFC,0xFFE}	
};
int MOT_RIGHTY_2[3][13] = 
{
	{60,60,60,60,60,50,50,50,50,50,50,50,50},
	{50,50,50,50,50,50,50,50,50,50,60,60,60},
	{0xFFE, 0xFFC, 0xFF9, 0xFF3, 0xFE7, 0xFCF, 0xF9F, 0xF3F, 0xE7F, 0xCFF, 0x9FF, 0x3FF, 0x7FF}	
};
int MOT_RIGHTY_3[3][14] = 
{
	{60,60,60,60,60,60,50,50,50,50,50,50,50,50},
	{50,50,50,50,50,50,50,50,50,50,50,60,60,60},
	{0xFFE, 0xFFC, 0xFF8, 0xFF1, 0xFE3, 0xFC7, 0xF8F, 0xF1F, 0xE3F, 0xC7F, 0x8FF, 0x1FF, 0x3FF, 0x7FF}
};

int LEFT_SIDE_SEARCH_SENON[3][14] = 
{
	{50,50,50,50,50,50,50,50,50,50,60,60,80,100},
	{50,100,80,60,60,60,50,50,50,50,50,50,50,50},
