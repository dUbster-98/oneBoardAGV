...
typedef struct AGV_DRIVING_INFORMATION {
	bool direction_info;	// lefty or righty - default: 0 : lefty
	bool move_start_flag;	// RFID_TAG_START
	bool turn_direction;	// left turn or right turn - default: 0 : left turn
	bool pin_action;		// down & go, up & go - default: 0 : down & go
...
typedef struct {
	...
	bool left_turn;				// ckr_jhshin_220712[Default Turn Direction is Left side -> TRUE, when FALSE -> Right side turn]
